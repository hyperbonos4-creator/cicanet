...
export default function CoverageMap({
  ...
  useEffect(() => {
    ...
    map.on("load", () => {
      ...
      // Mapa de calor de densidad de clientes (demanda) — modo Cobertura.
      map.addLayer({
        id: "clients-heat",
        type: "heatmap",
        source: "clients",
        layout: { visibility: "none" },
        paint: {
          "heatmap-weight": ["match", ["get", "estado"], "suspendido", 0.5, 1],
          "heatmap-intensity": ["interpolate", ["linear"], ["zoom"], 10, 1, 18, 3],
          "heatmap-radius": ["interpolate", ["linear"], ["zoom"], 10, 14, 18, 40],
          "heatmap-opacity": 0.7,
          "heatmap-color": [
