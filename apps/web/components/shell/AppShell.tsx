...
export type Section = "dashboard" | "clientes" | "red" | "ordenes" | "soporte" | "tickets" | "contabilidad" | "usuarios";
...
const NAV: { key: Section; label: string; sub: string; roles: string[]; icon: JSX.Element }[] = [
  ...
  {
    key: "red", label: "Red", sub: "Diseño · operación · cobertura", roles: ["admin", "operador"],
